...
ggplot(data=mpg,aes(x=class))+
  geom_bar(fill="blue")+
  ggtitle("Distribution of Cars by Class")+
  xlab("Type of Car")+
...
ggplot(data=mpg,aes(x=hwy))+
  ...
  ggtitle("Highway Mileage Distribution")+
...
ggplot(data = mpg, aes(x = displ, y = hwy)) + 
  geom_point()
library(ggplot2)
ggplot(data = mpg, aes(x = displ,color = class,y = hwy,shape = drv)) +
  geom_point(alpha = 0.7, size = 3) +
  geom_smooth(method = "loess", se = TRUE, color = "black") +
  ggtitle("Engine Displacement vs. Highway MPG") +
  xlab("Engine Size (liters)") +
  ylab("Highway MPG") +
  facet_wrap(vars(cyl), nrow = 2, ncol = 2) +
  theme_minimal()
```
